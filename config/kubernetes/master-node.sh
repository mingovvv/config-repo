...
kubeadm init --pod-network-cidr=20.96.0.0/12 --apiserver-advertise-address 192.168.4.4
...
kubectl create -f https://raw.githubusercontent.com/mingovvv/config-repo/master/config/kubernetes/calico-3.25.1.yaml
